export const cardComponent = (product) => {
    ...
    <div class="px-5 pb-5">
        ...
        <div class="flex items-center justify-between">
            <span class="text-3xl font-bold text-gray-900 dark:text-white">${product?.price||"invalid price"}</span>
            <a href="#"
